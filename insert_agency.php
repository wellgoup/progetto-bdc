...
$csv = array_map('str_getcsv', file('rour directory path'));
...
foreach ($csv as $key1 => $value1) {
  foreach ($value1 as $key2 => $value2) {
      ...
      $value1[$key2] = addslashes($value1[$key2]);  //backslash
...
//salto la prima stringa
  ...
  if ($int != 0){
        ...
        $sql = "INSERT INTO Agenzie (id_agenzia, nome_agenzia) VALUES (".$string.")";
